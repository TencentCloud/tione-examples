...
help_func() {
    echo "Usage:"
    echo "sh start_local.sh  [-t,--tiacc, 0/1]          open/close tiacc acceleration engine"
...
CONFIG_DEFAULT="../data/ --lr 0.01 --print-freq 5 --pretrained --local_world_size=$GPUS_PER_NODE --model_save_path=./model/"
